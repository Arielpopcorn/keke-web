...
const EasyLink = ({ href, children }) => (
  <a href={href} target="_blank" rel="noreferrer" style={{ color: '#407A52' }}>
    {children}
  </a>
);
...
export const RESEARCH_LIST = [{
    ...
    paragraph: [
      <>Plant-soil feedback (PSF) studies often treat soil microbial communities as a black box with a net positive or negative effect on plant performance. However, the microbial community consists of many different functional groups that interact with other belowground processes in distinct ways. To take a more mechanistic peek into this black box, previously we have developed models linking two major belowground processes: plant-mediated nutrient cycling (i.e., litter-mediated PSF) and plant-soil microbe interactions (i.e., microbial-mediated PSF). We have shown that plant litter decomposability, a key trait controlling nutrient cycling, can strongly increase PSF strength when mycorrhizal fungi are abundant, but not when pathogens dominate the microbial community. This result stems from the fact that the two microbial functional groups have different indirect interactions with litter dynamics. In particular, mycorrhizal fungi create an environment with depleted soil nutrients and enhanced litter production, and therefore, the benefits of having higher litter decomposability are amplified under such an environment (<EasyLink href="https://nph.onlinelibrary.wiley.com/doi/full/10.1111/nph.13215">Ke et al., 2015, New Phytologist</EasyLink>; <EasyLink href="https://www.frontiersin.org/journals/microbiology/articles/10.3389/fmicb.2015.01066/full">Ke and Miki, 2015, Frontiers in Microbiology</EasyLink>).</>,
      "",
      <>In recent collaborations, we are building mechanistic models that further integrate litter- and microbial-mediated PSFs into resource competition theory (<EasyLink href="https://besjournals.onlinelibrary.wiley.com/doi/10.1111/1365-2745.14156">Chung et al., 2023, Journal of Ecology</EasyLink>). For example, we are considering how different microbial functional groups (e.g., pathogens, mutualists, decomposers) influence the supply and demand of soil nutrients during plant competition. We are also conducting experiments to study how litter input affects the decay of PSF in California chaparral ecosystems (<EasyLink href="https://www.biorxiv.org/content/10.1101/2024.01.25.577053v2.full">Ou et al., biorxiv</EasyLink>). Together, we believe this will allow us to better predict the consequences of PSF across environmental contexts.</>,
    ]
  }, {
    id: "3",
    ...
    paragraph: [
      <>Growing evidence shows that soil microbes affect plant coexistence in a variety of systems. However, since these systems vary in the impacts microbes have on plants and in the ways plants compete with each other, it is challenging to integrate results into a general predictive theory. To this end, we have suggested that the concepts of niche and fitness differences from modern coexistence theory should be used to contextualize the diverse effects soil microbes have on plant coexistence (<EasyLink href="https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.1391">Ke and Wan, 2020, Ecological Monographs</EasyLink>). For example, by applying modern coexistence theory to a mechanistic model of plant-soil feedback, we have clarified how the interaction network predicts whether soil microbes affect primarily niche or fitness differences among competing plants, and how soil microbes affect the importance of plant-plant competition for resources. Based on perspectives from coexistence theory, we have also proposed an efficient experimental framework that can simultaneously quantify microbial effects and plant-plant competition, even in the presence of nonlinear density-dependency (<EasyLink href="https://link.springer.com/article/10.1007/s11104-022-05744-3">Ke and Wan, 2023, Plant and Soil</EasyLink>). In recent collaborations, we are applying this experimental design to understand plant competitive dynamics in natural ecosystems (<EasyLink href="https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/1365-2745.14040">Van Nuland et al., 2023, Journal of Ecology</EasyLink>; <EasyLink href="https://www.biorxiv.org/content/10.1101/2025.10.04.680482v1">Huang et al., 2026, Plant and Soil</EasyLink>).</>,
    ]
  }, {
    id: "4",
    ...
    paragraph: [
      <>When developing models to describe competitive interactions, ecologists often use either phenomenological models, such as Lotka-Volterra models, that summarize the net effects species have on one another, or mechanistic models, such as consumer-resource models, that explicitly describe the limiting factors underlying competition. Previously, we have connected these perspectives by linking modern coexistence theory with niche theory, showing how resource supply and consumer traits translate into changes in species’ niche and fitness differences, thereby leading to different competitive outcomes (<EasyLink href="https://esajournals.onlinelibrary.wiley.com/doi/10.1002/ecm.1242">Letten et al., 2017, Ecological Monographs</EasyLink>; <EasyLink href="https://www.nature.com/articles/s41559-018-0679-z?proof=t">Ke and Letten, 2018, Nature Ecology and Evolution</EasyLink>).</>,
      "",
      <>In recent collaborations, we have dug further into the details of calculating the niche and fitness components of modern coexistence theory. In particular, we showed that different definitions give different interpretations of the underlying mechanisms that shape species coexistence (<EasyLink href="https://nsojournals.onlinelibrary.wiley.com/doi/full/10.1111/oik.09573">Spaak et al., 2023, Oikos</EasyLink>). We have also extended modern coexistence theory to ask how niche and fitness differences predict not only competitive outcomes but also the structure and function of the coexisting community, an extension that we term functional coexistence theory (<EasyLink href="https://esajournals.onlinelibrary.wiley.com/doi/full/10.1002/ecm.70033">Wan et al., 2025, Ecological Monographs</EasyLink>). Together with collaborators, we are exploring how this new theory holds when considering multiple species and non-additivity in competition.</>,
    ]
  }, {
    id: "5",
    ...
    paragraph: [
      <>Epiphytic bird's nest ferns (<i>Asplenium nidus</i>) create suspended soil habitats high in forest canopies, forming natural 'biotic islands' that host diverse microbial communities. Because each fern varies in size, age, and spatial isolation, this system provides a unique opportunity to ask how classical ideas from island biogeography and metacommunity theory apply to habitats that are themselves formed and modified by living organisms. In recent work, we have used bird's nest ferns to test how patch size and isolation shape fungal and bacterial diversity, and to identify the mechanisms underlying these patterns. Our results suggest that larger ferns support higher microbial diversity because their growth creates stronger environmental heterogeneity through decomposition-driven pH gradients within the nest structure (<EasyLink href="https://www.biorxiv.org/content/10.64898/2026.03.30.715435v1">Tseng et al. biorxiv</EasyLink>). This makes bird's nest ferns an especially exciting system for linking local habitat complexity with regional processes such as dispersal.</>,
      "",
